...
function PopNewCard({ isOpen, onClose, onTasksUpdate }) {
  ...
  const [hoveredDate, setHoveredDate] = useState(null); // дата под курсором
  ...
  const renderCalendarCells = () => {
    ...
    // Дни следующего месяца (до заполнения 6 недель)
    const remainingCells = 42 - cells.length; // 6 недель * 7 дней
...
<form onSubmit={handleSubmit}>
  ...
  {/* 3. Описание + календарь на одном уровне */}
